...
def model_prediction(test_image):
    ...
    image = keras.utils.load_img(temp_file_path, target_size=(128, 128))  # Use keras.utils.load_img
    input_arr = keras.utils.img_to_array(image)  # Use keras.utils.img_to_array
